...
============================================================
REQUEST_TIMEOUT = 30 
Таймфрейм изменен на 4 часа [1]
CANDLE_INTERVAL = "CANDLE_INTERVAL_4_HOUR"
Увеличена глубина загрузки истории в часах (с 14 дней до 60 дней),
чтобы для 4-часового таймфрейма хватало свечей для анализа [1]
HISTORY_HOURS = 24 * 60 
...
html += ` 
Инструмент	Направление	Вход 	Выход 	Цена входа 	Цена выхода	Результат 	Комиссия	Налог	Чистый результат
${trade.title}	${trade.direction}	${trade.entry_time}	${trade.exit_time}	${trade.entry_price}	${trade.exit_price}	${money(
trade.gross_result
)} ₽ 	${money(
commission
)} ₽ 	${money(
